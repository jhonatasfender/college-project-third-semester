                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Realmente tenho certeza que desejo excluir o registro {{ $category->name }}.</p>
                                    {{ csrf_field() }} {{ method_field('DELETE') }}
                                </div>
                                <div class="modal-footer">
                                    <a href="{{route('categories.destroy', [$category])}}" class="btn btn-primary">Não tenho certeza</a>
